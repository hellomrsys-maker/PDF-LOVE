# PDFLove Privacy Policy

*Last updated: [fill in date before publishing]*

## The short version

PDFLove processes your files entirely on your own device. For the vast
...
- **Advertising** (if enabled by whoever is operating this deployment):
  PDFLove's free tier can optionally show a passive banner ad or an
...
If you're using a self-hosted or enterprise deployment of PDFLove with
